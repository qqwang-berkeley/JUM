...
while(<IN1>) {
    ...
    if($_ !~ /raw_count/) {
	 ...
	 $sum2=0;
	     ...
	     if($enter_1[$s]+$enter_2[$s]+$enter_3[$s] != 0) {	
		    $ratio[$s]=($enter_2[$s]+$enter_3[$s])/($enter_1[$s]+$enter_2[$s]+$enter_3[$s]);
	     ...
	     if($enter_1[$m]+$enter_2[$m]+$enter_3[$m] != 0) {	
		    $ratio[$m]=($enter_2[$m]+$enter_3[$m])/($enter_1[$m]+$enter_2[$m]+$enter_3[$m]);
